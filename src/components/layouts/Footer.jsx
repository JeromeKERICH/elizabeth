const Footer = () => {
    return (
      <footer className="bg-[#001F3F] text-white pt-16 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {/* Brand Column */}
            <div>
              <h3 className="text-2xl font-bold mb-4">Elizabeth Nasaka</h3>
              <p className="text-[#D4AF37] mb-6 italic">
                "The Courage to Grow™"
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="hover:text-[#D4AF37] transition-colors">Framework</a></li>
            ...
            <div>
              ...
              <a href="mailto:hello@elizabethnasaka.com" className="block mb-6 hover:text-[#D4AF37] transition-colors">
                hello@elizabethnasaka.com
              </a>
          ...
          {/* Copyright + Signature */}
          <div className="mt-16 pt-8 border-t border-[#ffffff20] text-center text-sm text-white text-opacity-70">
            <p>© {new Date().getFullYear()} Elizabeth Nasaka. All rights reserved.</p>
            <p className="mt-2 italic text-[#D4AF37]">Made with courage by Emmanuel Kerich</p>
          </div>
        </div>
      </footer>
    );
